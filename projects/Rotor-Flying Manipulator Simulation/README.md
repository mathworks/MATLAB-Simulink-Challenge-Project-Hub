Fill out this <strong>[form](https://www.mathworks.com/academia/student-challenge/mathWorks-excellence-in-innovation-signup.html?tfa_1=Rotor-Flying Manipulator Simulation&tfa_2=47)</strong> to **register** your intent to complete this project.s

Fill out this <strong>[form](https://www.mathworks.com/academia/student-challenge/mathworks-excellence-in-innovation-submission-form.html?tfa_1=Rotor-Flying Manipulator Simulation&tfa_2=47)</strong> to **submit** your solution to this project and qualify for the rewards.
