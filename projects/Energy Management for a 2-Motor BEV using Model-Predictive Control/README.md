Fill out this <strong>[form](https://www.mathworks.com/academia/student-challenge/mathWorks-excellence-in-innovation-signup.html?tfa_1=Energy Management for a 2-Motor BEV using Model-Predictive Control&tfa_2=246)</strong> to **register** your intent to complete this project.

Fill out this <strong>[form](https://www.mathworks.com/academia/student-challenge/mathworks-excellence-in-innovation-submission-form.html?tfa_1=Energy Management for a 2-Motor BEV using Model-Predictive Control&tfa_2=246)</strong> to **submit** your solution to this project and qualify for the rewards.
