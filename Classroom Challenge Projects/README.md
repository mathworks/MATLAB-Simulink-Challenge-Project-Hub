...
|<ul><li>Follow the [instructions](#discussion-board) to create a discussion board for your classroom or program for students to collaborate and ask questions (this board will be periodically monitored by MathWorks staff)</li><li>Assign students to teams (if using teams) and encourage teams to sign a [teamwork agreement](https://github.com/mathworks/MATLAB-Simulink-Challenge-Project-Hub/blob/main/Classroom%20Challenge%20Projects/Faculty%20Resources/Teamwork%20Agreement%20Template.docx) (if needed). This teamwork agreement is *optional and for student use only*, not to be submitted to MathWorks.</li><li>Review the [Generative AI Guidelines](#generative-ai-guidelines) with your students</li></ul>|~1 week before project work begins|<ul><li>[Instructions](#discussion-board) to create a discussion board</li><li>[Example teamwork agreement](https://github.com/mathworks/MATLAB-Simulink-Challenge-Project-Hub/blob/main/Classroom%20Challenge%20Projects/Faculty%20Resources/Teamwork%20Agreement%20Template.docx)</li><li>[Generative AI Guidelines](#generative-ai-guidelines)</li></ul>|
|**STEP 4: Project work**|
