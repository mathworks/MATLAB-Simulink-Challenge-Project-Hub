...
2.	[MATLAB GPT](https://chatgpt.com/g/g-QFTjbeK3U-matlab), available in OpenAI, searches [MathWorks web pages](mathworks.com) to answer questions about MATLAB workflows. As an AI-powered conversational assistant, MATLAB GPT provides contextual guidance, enables you to quickly discover resources and stay up to the date with the latest features, and generates MATLAB code directly from plain-language descriptions. 
