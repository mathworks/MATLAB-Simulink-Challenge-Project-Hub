...
|<ul><li>[Submit](https://forms.office.com/r/hWCBGQZs1K) student names for MathWorks certificates of completion</li><li>*Optional*: You may submit 1-3 exceptional student projects for MathWorks team review and prize</li><li>Student projects nominated for MathWorks review must be submitted as GitHub repositories. Please ensure students follow the provided [instructions](#instructions-for-nominated-project-solution-submissions).</li></ul>|1-2 weeks following project submission|<ul><li>[Submission form](https://forms.office.com/r/hWCBGQZs1K)</li><li>[Available rewards](#rewards)</li><li>[Student instructions](#instructions-for-nominated-project-solution-submissions) for nominated project solution submission</li></ul>|
