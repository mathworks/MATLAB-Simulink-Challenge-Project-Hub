...
<p><strong>Suggested Courses where Project can be used:</strong> Introduction to Programming, Linear Algebra, Introduction to Engineering, Introduction to Data Science</p>
...
<p><strong>Skills Gained: </strong>Drone structural design, thrust-to-weight analysis, payload capacity estimation, finite element analysis, CAD </p>
